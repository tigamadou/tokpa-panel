...
// ** Store & Actions
import { getComments, getCommentSearchFiltered } from "../store"
        ...
        >
          <div className="d-flex align-items-center">
            ...
            <Input
              ...
              placeholder={t('search.search_comment')}
            />
          </div>
        </Col>
      </Row>
...
const CommentsList = () => {
  ...
  useEffect(() => {
    setLoading(true)
    getCommentList("/comments/?blocked=true")
    .then((res) => {
      dispatch(
        getComments({
          q: value,
  ...
  const handleFilter = (val) => {
    ...
    const filteredData = store.allData.filter((comment) => {
      /* eslint-disable operator-linebreak, implicit-arrow-linebreak */
      return (
        comment.content.toLowerCase().includes(queryLowered)
      )
    })
    dispatch(
      getCommentSearchFiltered({
        data: filteredData,
